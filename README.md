...
| **HoYo 게임 자동 출석**                                         | **실시간 메모**                                                 | **엔드 콘텐츠 일정**                                             |
|:---------------------------------------------------------------:|:---------------------------------------------------------------:|:---------------------------------------------------------------:|
| <img src="./Picture/p01.png?raw=true" width="521" height="586"> | <img src="./Picture/p02.png?raw=true" width="597" height="586"> | <img src="./Picture/p03.png?raw=true" width="518" height="586"> |
| 출석 마다 전송                                                   | 1회 전송, 이후 내용 수정                                          | 1회 전송, 이후 내용 수정                                          |
...
- **실행 확인 방법 :**
    - **`⑂ Fork`** 로 복사된 본인 저장소에서 → **상단 탭 `▶️Actions`** → `실행파일 (아무거나)` → 오른쪽 끝에 `Run workflow ▼` → `Run workflow`
    - 실행 완료 후 `run-all`/`note-and-endgame`/`checkin`에서 실행 로그 확인 가능.

|<img src="./Picture/p07.png?raw=true" width="612" height="520"> | <img src="./Picture/p08.png?raw=true" width="644" height="520"> |
|:--------------------------------------------------------------:|:---------------------------------------------------------------:|
